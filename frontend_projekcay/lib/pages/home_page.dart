  ...
  List<Map<String, dynamic>> rekomendasiWisataDummy = [
    {
      ...
      'link': 'https://maps.app.goo.gl/AvpyxKRfaNCBdegi6'
    },
    {
      'name': 'Pura Besakih',
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      crossAxisSpacing: 15,
                      mainAxisSpacing: 15,
                      childAspectRatio: 0.75, // Menyesuaikan rasio agar item lebih proporsional
                    ),
                        ...
                        child: Card(
                          ...
                          child: Column(
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(10),
                                child: Image.network(wisata['photoUrl'], height: 100, width: double.infinity, fit: BoxFit.cover),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(wisata['name'], style: TextStyle(fontWeight: FontWeight.bold)),
                              ),
                            ],
                          ),
                        ),
